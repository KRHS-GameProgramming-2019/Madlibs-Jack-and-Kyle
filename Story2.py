...
def Story2(debug):
    ...
    character2 = Getters.getMario_Character("")
    character3 = Getters.getMario_Character("")
    color3 = Getters.getColor("")
    noun3 = Getters.getWord("")
    noun4 = Getters.getWord("")
    kartType1 = Getters.getVehicle("")
    noun5 = Getters.getWord("")
