...
def Story3(debug=False):
	...
	action1 = ("Enter a synonym for jummped: ")
	number1 = Getters.getNumber("Enter a number: ")
	...
	number2 = Getters.getNumber("Enter a number between 1 and 10: ",10)
	SFL1 = Getters.getSFL("Enter a synonym for large: ")
	villain1 = Getters.getMario_Villains("Enter a Mario Villain: ")
	number3 = Getters.getNumber("Enter a number between 1 and 24: ",24)
	restauraunt1 = ("Enter a restauraunt name: ")
	print("\n")
	...
	output += "All three of the friends left the castle with no more encounters and decided to celebrate by going to "+restauraunt1" \n"
